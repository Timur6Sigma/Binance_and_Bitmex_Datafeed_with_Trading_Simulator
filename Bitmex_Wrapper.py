...
class bitmex_wrapper:
    # At Start: Establish connection with the Bitmex-websocket and subscribe to the parsed datafeeds with respect to the instruments
    # Then: Receives and handles responses from the Bitmex-websocket -> stores bids and asks (instrument, ID, Buy or Sell, size and price)
    #   in lists and the best bid and best ask (price and size)

    def __init__(self, numpy, json, websocket, subscriptions):
        self.initiation_okay = "-Successfully connected to Bitmex-"    # initVarFirstTime
        ...
        if self.initiation_okay == "-Successfully connected to Bitmex-":
            try:
